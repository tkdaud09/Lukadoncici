...
//학생정보를 저장하기 위한 클래스 - VO 클래스(DTO 클래스, POJO 클래스 - plane Old Java Object)
...
public class Student {
	...
	public void setName(String name) {
		this.name = name;
		System.out.println("*** Student 클래스의 setNum(String name) 메소드 호출 ***");
	}
	...
	public void setEmail(String email) {
		this.email = email;
		System.out.println("*** Student 클래스의 setNum(String email) 메소드 호출 ***");
	}
