...
//☆☆☆ File에서 bean 엘리먼트로 클래스를 Spring Bean 등록 - root-context.xml(모든 front controller가 같은 객체를 사용하고 싶을때)
//															또는 servlet-context.xml (보통 사용) ☆☆☆
...
// => 생성자가 하나만 있는 경우 생성자에 @AutoWired 어노테이션을 생략 가능
