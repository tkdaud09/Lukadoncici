...
//일반적으로 연산식은 왼쪽에서 오른쪽 방향으로 처리되지만 단항 연산자와 대입연산자를
//사용한 연산식은 오른쪽에서 왼쪽 방향으로 처리
//ex) A+B+C              A=B=C
//   -----→            ←-----
...
public class OperatorApp {
	public static void main(String[] args) {
		...
		int result1=++a4;//전처리 : ++a4 연산식이 실행된 후 resutl1=a4 연산식 실행
		...
		//형식) 조건식 ? 참값 : 거짓값;
		// => 조건식의 결과이 true인 경우 참값을 제공하고 false인 경우 거짓값을 제공하는 연산자
