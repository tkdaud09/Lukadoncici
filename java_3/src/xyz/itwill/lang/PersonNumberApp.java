...
//키보드로 주민번호를 입력받아 주민번호를 이용하여 생년월일과 성별을 제공받아 출력하는 프로그램
// => 주민번호는 14자리로 입력받고 7번째 자리에 반드시 - 문자가 존재
// => 비정상적인 주민번호가 입력된 경우 에러 메세지를 출력 후 재입력되도록 처리
//ex) 주민번호[ex.901225-1234567] >> 000101-456789
...
public class PersonNumberApp {
	public static void main(String[] args) {
		...
		while(true) {
			...
			number=scanner.nextLine().replace(" ","");//모든 공백 제거
		...
		//입력된 주민번호에서 8번째 위치의 문자 하나를 분리하여 저장
