...
//Java 프로그램 개발에 프로그램 기능 제공 하기 위한 도구
// => 라이브러리를 이용하여 배포된 Java 자료형(클래스, 인터페이스, 열거형) 
// => API문서를 활용항 Java 자료형에 대한 설명을 제공받아 사용
...
// = > 모든 Java 클래스를 대신하여 사용할수 있는 대표클래스 
...
public class SystemApp {
	public static void main(String[] args) {
		...
		//System.out : Java에서 제공되는 표준 출력장치(모니터)에 대한 출력스트림(객체)이 저장된다
		...
		//System.currentTimeMillis() : 시스템의 현재 날짜와시간에 대한 타임스템프(TimeStamp)를 반환하는 메소드
