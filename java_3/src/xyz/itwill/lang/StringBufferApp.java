...
//String Buffer 클래스 : 문자열을 저장하기 위한 클래스
// => String 객체는 저장된 문자열을 조작하기 위한 메소드 제공하지 않고 조작 결과를 반환하는
// 메소드 제공 -문자열 간접 처리
//=> String Buffer 객체에 저장된 문자열을 조작하기 위한 메소드 제공 - 문자열 직접 처리
...
public class StringBufferApp {
	public static void main(String[] args) {
		...
		//매개변수르 전달받은 문자열을 원하는 위치(첨자)에 삽입하는 메소드
		sb.insert(4, "X");
		System.out.println("sb = "+sb);//ABCDXEF
		System.out.println("==============================================================");
		//StringBuffer.insert(int index, object o) : StringBuffer 객체에 저장된 문자열에서
