...
//도메인(Domain) : 인터넷을 사용하기 위해 네트워크 그룹 또는 호스트에게 부여하는 문자로 된
//네트워크 식별자
// => 도메인 그룹에 등록되어 있어야 호스트 사용 가능 - 도메인 호스트 

//포트번호(Port Number) : 네트워크 기능을 이용하여 데이터를 송수신하기 위한 고유의 통신 경로
// => 네트워크 프로그램은 반드시 0~65535 범위의 포트 중 하나를 사용하여 데이터 전송
// => 0 ~ 1023 : Well-Known Prot(HTTP : 80, HTTP : 443, SMTP : 25, POP3 : 110 등)
