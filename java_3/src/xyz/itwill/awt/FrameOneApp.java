...
// => Button, List, Label, Canvas, Checkbox, Choice, Scrollbar, TexField, TextArea 등
...
public class FrameOneApp {
	public static void main(String[] args) {
		...
		//Component.setVisible(boolean b) : 컴퍼넌트를 보이지 않게 처리하거나 
		//보이도록 처리하는 메소드 - false : 보이지 않도록 처리 , true : 보여지도록 처리
