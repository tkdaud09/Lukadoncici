...
회원정보를 입력태그의 초기값으로 출력하고 변경할 회원정보를 입력받기 위한 JSP 문서 --%>
<%-- => 로그인 상태의 사용자만 요청 가능한 JSP 문서 --%>
<%-- => [회원변경] 태그를 클릭한 경우 [member/member_modify_action.jsp] 문서 요청 - 입력값(회원정보) 전달 --%>
...
<form id="join" action="<%=request.getContextPath() %>/member/member_modify_action.jsp" method="post">
<fieldset>
